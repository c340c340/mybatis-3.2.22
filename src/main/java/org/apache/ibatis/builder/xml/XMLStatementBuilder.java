...
public class XMLStatementBuilder extends BaseBuilder {
  ...
  public void parseStatementNode() {
    ...
    Integer fetchSize = context.getIntAttribute("fetchSize");//设置返回的结果数
    Integer timeout = context.getIntAttribute("timeout");//超时时间
    String parameterMap = context.getStringAttribute("parameterMap");//已经被弃用
    String parameterType = context.getStringAttribute("parameterType");
    Class<?> parameterTypeClass = resolveClass(parameterType);
    String resultMap = context.getStringAttribute("resultMap");
    String resultType = context.getStringAttribute("resultType");
    String lang = context.getStringAttribute("lang");//????官方文档没看到
    ...
    SqlCommandType sqlCommandType = SqlCommandType.valueOf(nodeName.toUpperCase(Locale.ENGLISH));//类型，select/insert/update/delete
